...
function GalleryImage({ index, left, top, key, photo, onClick }) {
  return (
    ...
    >
      <Img
        fluid={photo}
        style={{ margin: MARGIN, height: photo.height, width: photo.width, cursor: 'pointer' }}
      />
    </div>
  );
}
...
const GalleryPage = () => {
  ...
  const [howwemetPreviewPhotos, howwemetFullscreenPhotos] = getPhotos(data2.howwemet);

  const [currentImage, setCurrentImage] = useState(0);
  const [fullscreenPhotos, setFullscreenPhotos] = useState(engagementFullscreenPhotos);
    ...
    <div className="section">
      <div className="section-container">
        ...
        <p className="narrow-column">
          ...
          traveling to Poland and Germany - Holly and Eli had arranged to take a
          sunset hot air balloon ride. With some additional planning and a
          gorgeous ring he picked himself, Eli turned this outing into a perfect
          surprise proposal!
        </p>
        <Gallery
        ...
        style ={{
          ...
          width: '100%',
          height: '100%',
        }} src="https://www.youtube.com/embed/Tczp4_kkVus" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        </div>
        </div>
        <div className="section">
      <div className="section-container">
        ...
        <p className="narrow-column">
          Over the past 4 years Eli and Holly have been fortunate to be able to
          travel the world! So far they’ve been to 11 countries together!
          Inspired by Eli’s globetrotting past they’ve visited some familiar
          locations and many new ones and have enjoyed sharing these experiences
          with each other. They look forward to seeing some exciting new
